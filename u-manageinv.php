				...
				<form action="php/deleteItem.inc.php">
					...
					<?php
						...
						<tr>
							...
							<td>
							<a href='u-editItem.php?id=<?php echo $row['Item_ID']?>'  class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href='u-deleteInv.php?id=<?php echo $row['Item_ID']?>'><i class="material-icons" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="php/u-addItem.inc.php" method="post">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="Incstock" required>
					</div>					
				</div>
		...
		<div class="modal-content">
				...
				<div class="modal-body">					
					<form action="" method="post">
						<input type="text" placeholder="Item name" name="Itemname" value="<?php echo $row['Item_name']?>">
						<input type="text" placeholder="Description" name="description" value="<?php echo $row['Item_description']?>">
						<input type="text" placeholder="Price" name="price" value="<?php echo $row['Item_price']?>">
						<input type="text" placeholder="Stock" name="stock" value="<?php echo $row['Item_stock']?>">
						<input type="text" placeholder="Incoming Stock" name="Incstock" value="<?php echo $row['Incoming_stock']?>">
						<button type="submit"name="save">Save</button>  
						<a href="u-manage-inventory.php">Cancel</a>       
					</form>
				</div>
				<div class="modal-footer">
					<input type="submit" class="btn btn-info" name="save">Save</button>  
				</div>
		</div>
	</div>
</div>
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
		<form action="php/deleteItem.inc.php" method="post">
				<div class="modal-header">						
