...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<img style="width: 100px; height: 100px;" src="images/AdminIcon.png">
			<h1 style="text-align:left">
				...
				<br>
				<hr>
				<p style ="font-size: 22px;"> Below is a summary of all the total users, items, stocks, and incoming stocks in your inventory! </p>
                <hr>
			<div class="row">
			<div class="column">
				<div class="card">
				...
				$user_count_query_run = mysqli_query($conn, $user_count_query);
				$user_total = mysqli_num_rows($user_count_query_run);
