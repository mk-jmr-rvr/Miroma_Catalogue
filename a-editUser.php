...
$sql = "UPDATE `user` SET `first_name`='$Fname',`last_name`='$Lname',`username`='$username' WHERE UserID=$id";
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="a-manageuser.php" class="btn btn-danger" data-toggle="modal">X</a>
					</div>
				</div>
			</div>
				<div class="Deletecontainer">	
					...
					<form action="" method="post">
						...
						<div class="form-group">
								...
								<input type="text" placeholder="First Name" class="form-control" name="Fname" value="<?php echo $row['first_name']?>">
							</div>
							<div class="form-group">
								<label>Last Name</label>
								<input type="text" placeholder="Last Name" class="form-control" name="Lname" value="<?php echo $row['last_name'] ?>">
							</div>
							<div class="form-group">
								<label>Username</label>
								<input type="text" placeholder="Username" class="form-control" name="username" value="<?php echo $row['username'] ?>">
							</div>			
						</div>
