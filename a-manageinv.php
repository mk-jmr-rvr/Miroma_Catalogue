				...
				<form action="php/deleteItem.inc.php">
					...
					<?php
						...
						<tr>
							...
							<td>
							<a href='a-editItem.php?id=<?php echo $row['Item_ID']?>'  class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href='a-deleteInv.php?id=<?php echo $row['Item_ID']?>'><i class="material-icons" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
